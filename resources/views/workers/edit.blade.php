...
<div class="mdl-cell mdl-cell--12-col">
	<form id="task-form__edit" action="{{ action('WorkerController@update', $worker->id) }}" method="post">
		{{ csrf_field() }}
		...
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="text" name="meta[job]" value="{{ $worker->job }}" />
			<label class="mdl-textfield__label">Job</label>
		</div>
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="number" step="0.01" name="meta[rate]" value="{{ $worker->rate }}" />
			<label class="mdl-textfield__label">Rate</label>
		</div>
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="date" name="meta[birthday]" value="{{ $worker->birthday }}" />
			<label class="mdl-textfield__label">Birthday</label>
		</div>
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="text" name="meta[bank]" value="{{ $worker->bank }}" />
			<label class="mdl-textfield__label">Bank account</label>
		</div>
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<textarea class="mdl-textfield__input" name="meta[address]">{{ $worker->address }}</textarea>
			<label class="mdl-textfield__label">Address</label>
		</div>
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<textarea class="mdl-textfield__input" name="meta[note]">{{ $worker->note }}</textarea>
			<label class="mdl-textfield__label">Note</label>
		</div>
		<div class="mdl-layout-spacer"></div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="text" name="meta[gdrive]" value="{{ $worker->gdrive }}" />
